<template>
  <div class="grid grid-vertical">
    ...
    <span class="grid grid-centering" v-if="curedit.embeddings[0].hotspots.indexOf(selected) < 0" style="width:100%; grid-template-areas:'c b' 'a a';">
      ...
      <el-checkbox v-model="hidespot" style="margin:0; color:gray; grid-area: a; justify-self: flex-end;">隐藏呼吸灯</el-checkbox>
    </span>
