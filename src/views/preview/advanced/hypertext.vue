<template>
  <div style="width:100%; height:100%; display:flex; justify-content:center; align-items:center; color:white">
    ...
    <overlayer class="iframe" v-model="showDialog">
      <quill-editor v-model="item.content" :options="editorOption" style="height: 100%; display: flex; flex-direction: column; background:white; border-radius: 10px;" ref="editor" :disabled="true"/>
    </overlayer>
  </div>
</template>
